namespace Template {
  export async function one_villageEntrance(): ƒS.SceneReturn {
   ...
   // await ƒS.update();
    ...
    switch (dialogueElement) {
      case helpYesNo.iSayYes:
        ...
        await ƒS.update();
        console.log("name" + characters.protagonist.name);
        console.log("name to save: " + dataForSave.nameProtagonist);
        break;
